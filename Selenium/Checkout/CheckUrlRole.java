...
//            }
    ...
    public void TC_09_Category_books() {
        ...
        Url.add("2-week-keto-meal-plan                          ");
        for (String url : Url) {
            driver.get("https://release.drberg.com/books/" + url);
            sleepInSeconds(5);
//            if (driver.findElement(By.xpath("//a[text() = 'Home']")).isDisplayed())
//            {
//                System.out.println("SP success:" + Url);
...
//            }
    ...
    public void TC_09_Category_devices() {
        ...
        Url.add("shaker-bottle");
        for (String url : Url) {
            driver.get("https://release.drberg.com/devices/" + url);
            sleepInSeconds(5);
//            if (driver.findElement(By.xpath("//a[text() = 'Home']")).isDisplayed())
//            {
//                System.out.println("SP success:" + Url);
...
//            }
    ...
    public void TC_09_Category_digital_programs() {
        ...
        Url.add("summit-2020-digital-recording");
        for (String url : Url) {
            driver.get("https://release.drberg.com/digital-programs/" + url);
            sleepInSeconds(5);
//            if (driver.findElement(By.xpath("//a[text() = 'Home']")).isDisplayed())
//            {
//                System.out.println("SP success:" + Url);
...
//            }
    ...
    public void TC_09_Category_powders() {
        ...
        Url.add("electrolyte-variety-pack                        ");
        for (String url : Url) {
            driver.get("https://release.drberg.com/powders/" + url);
            sleepInSeconds(5);
//            if (driver.findElement(By.xpath("//a[text() = 'Home']")).isDisplayed())
//            {
//                System.out.println("SP success:" + Url);
...
//            }
    ...
    public void TC_09_Category_supplements() {
        ...
        Url.add("whole-food-multivitamin-with-minerals          ");
        for (String url : Url) {
            driver.get("https://release.drberg.com/supplements/" + url);
            sleepInSeconds(3);
//            if (driver.findElement(By.xpath("//a[text() = 'Home']")).isDisplayed())
//            {
//                System.out.println("SP success:" + Url);
...
//            }
    ...
    public void TC_09_Category_immune() {
        ...
        Url.add("advanced-immune-support");
        for (String url : Url) {
            driver.get("https://release.drberg.com/immune/" + url);
            sleepInSeconds(5);
//            if (driver.findElement(By.xpath("//a[text() = 'Home']")).isDisplayed())
//            {
//                System.out.println("SP success:" + Url);
...
//            }
    ...
    public void TC_09_Category_all_products() {
        ...
        Url.add("whole-food-multivitamin-with-minerals             ");
        for (String url : Url) {
            driver.get("https://release.drberg.com/all-products/" + url);
            sleepInSeconds(5);
//            if (driver.findElement(By.xpath("//a[text() = 'Home']")).isDisplayed())
//            {
//                System.out.println("SP success:" + Url);
...
//            }
    ...
    public void TC_09_Category_beauty() {
        ...
        Url.add("biotin-shampoo                               ");
        for (String url : Url) {
            driver.get("https://release.drberg.com/beauty/" + url);
            sleepInSeconds(5);
//            if (driver.findElement(By.xpath("//a[text() = 'Home']")).isDisplayed())
//            {
//                System.out.println("SP success:" + Url);
...
//            }
    ...
    public void TC_09_Category_bundles() {
        ...
        Url.add("clean-shine-conditioner-clean-lather-shampoo");
        for (String url : Url) {
            driver.get("https://release.drberg.com/bundles/" + url);
            sleepInSeconds(5);
//            if (driver.findElement(By.xpath("//a[text() = 'Home']")).isDisplayed())
//            {
//                System.out.println("SP success:" + Url);
...
//            }
    ...
    public void TC_10_product_id_Category_books() {
        ...
        Url.add("522");
        for (String url : Url) {
            driver.get("https://release.drberg.com/catalog/product/view/id/" + url +"/category/3");
            sleepInSeconds(5);
//            if (driver.findElement(By.xpath("//a[text() = 'Home']")).isDisplayed())
//            {
//                System.out.println("SP success:" + Url);
...
//            }
    ...
    public void TC_10_product_id_Category_devices() {
        ...
        Url.add("249");
        for (String url : Url) {
            driver.get("https://release.drberg.com/catalog/product/view/id/" + url +"/category/4");
            sleepInSeconds(5);
//            if (driver.findElement(By.xpath("//a[text() = 'Home']")).isDisplayed())
//            {
//                System.out.println("SP success:" + Url);
...
//            }
    ...
    public void TC_10_product_id_Category_digital_programs() {
        ...
        Url.add("431");
        for (String url : Url) {
            driver.get("https://release.drberg.com/catalog/product/view/id/" + url +"/category/5");
            sleepInSeconds(5);
//            if (driver.findElement(By.xpath("//a[text() = 'Home']")).isDisplayed())
//            {
//                System.out.println("SP success:" + Url);
...
//            }
    ...
    public void TC_10_product_id_Category_powders() {
        ...
        Url.add("501");
        for (String url : Url) {
            driver.get("https://release.drberg.com/catalog/product/view/id/" + url +"/category/6");
            sleepInSeconds(5);
//            if (driver.findElement(By.xpath("//a[text() = 'Home']")).isDisplayed())
//            {
//                System.out.println("SP success:" + Url);
...
//            }
    ...
    public void TC_10_product_id_Category_supplements() {
        ...
        Url.add("554");
        for (String url : Url) {
            driver.get("https://release.drberg.com/catalog/product/view/id/" + url +"/category/7");
            sleepInSeconds(3);
//            if (driver.findElement(By.xpath("//a[text() = 'Home']")).isDisplayed())
//            {
//                System.out.println("SP success:" + Url);
...
//            }
    ...
    public void TC_10_product_id_Category_immune() {
        ...
        Url.add("428");
        for (String url : Url) {
            driver.get("https://release.drberg.com/catalog/product/view/id/" + url +"/category/107");
            sleepInSeconds(5);
//            if (driver.findElement(By.xpath("//a[text() = 'Home']")).isDisplayed())
//            {
//                System.out.println("SP success:" + Url);
...
//            }
    ...
    public void TC_10_product_id_Category_all_products() {
        ...
        Url.add("553");
        for (String url : Url) {
            driver.get("https://release.drberg.com/catalog/product/view/id/" + url +"/category/110");
            sleepInSeconds(5);
//            if (driver.findElement(By.xpath("//a[text() = 'Home']")).isDisplayed())
//            {
//                System.out.println("SP success:" + Url);
...
//            }
    ...
    public void TC_10_product_id_Category_beauty() {
        ...
        Url.add("546");
        for (String url : Url) {
            driver.get("https://release.drberg.com/catalog/product/view/id/" + url +"/category/111");
            sleepInSeconds(5);
//            if (driver.findElement(By.xpath("//a[text() = 'Home']")).isDisplayed())
//            {
//                System.out.println("SP success:" + Url);
...
//            }
    ...
    public void TC_10_product_id_Category_bundles() {
        ...
        Url.add("496");
        for (String url : Url) {
            driver.get("https://release.drberg.com/catalog/product/view/id/" + url +"/category/88");
            sleepInSeconds(5);
//            if (driver.findElement(By.xpath("//a[text() = 'Home']")).isDisplayed())
//            {
//                System.out.println("SP success:" + Url);
...
//            }
    ...
    public void TC_11_Parent_Category_sleep() {
        ...
        Url.add("sleep-aid");
        for (String url : Url) {
            driver.get("https://release.drberg.com/health-concern/sleep/" + url);
            sleepInSeconds(3);
//            if (driver.findElement(By.xpath("//a[text() = 'Home']")).isDisplayed())
//            {
//                System.out.println("SP success:" + Url);
...
//            }
    ...
    public void TC_11_Parent_Category_digestion() {
        ...
        Url.add("friendly-bacteria-probiotic");
        for (String url : Url) {
            driver.get("https://release.drberg.com/health-concern/digestion/" + url);
            sleepInSeconds(3);
//            if (driver.findElement(By.xpath("//a[text() = 'Home']")).isDisplayed())
//            {
//                System.out.println("SP success:" + Url);
...
//            }
    ...
    public void TC_11_Parent_Category_weight_loss() {
        ...
        Url.add("ketogenic-desserts-yummies-digital-ebook");
        for (String url : Url) {
            driver.get("https://release.drberg.com/health-concern/weight-loss/" + url);
            sleepInSeconds(3);
//            if (driver.findElement(By.xpath("//a[text() = 'Home']")).isDisplayed())
//            {
//                System.out.println("SP success:" + Url);
...
//            }
    ...
    public void TC_11_Parent_Category_keto() {
        ...
        Url.add("electrolyte-orange                        ");
        for (String url : Url) {
            driver.get("https://release.drberg.com/health-concern/keto/" + url);
            sleepInSeconds(3);
//            if (driver.findElement(By.xpath("//a[text() = 'Home']")).isDisplayed())
//            {
//                System.out.println("SP success:" + Url);
...
//            }
    ...
    public void TC_11_Parent_Category_stress() {
        ...
        Url.add("keto-essential-aminos");
        for (String url : Url) {
            driver.get("https://release.drberg.com/health-concern/stress/" + url);
            sleepInSeconds(3);
//            if (driver.findElement(By.xpath("//a[text() = 'Home']")).isDisplayed())
//            {
//                System.out.println("SP success:" + Url);
...
//            }
    ...
    public void TC_11_Parent_Category_antioxidant_detoxification() {
        ...
        Url.add("estrogen-balance-with-dim");
        for (String url : Url) {
            driver.get("https://release.drberg.com/health-concern/antioxidant-detoxification/" + url);
            sleepInSeconds(3);
//            if (driver.findElement(By.xpath("//a[text() = 'Home']")).isDisplayed())
//            {
//                System.out.println("SP success:" + Url);
...
//            }
    ...
    public void TC_11_Parent_Category_endocrine_support() {
        ...
        Url.add("keto-essential-aminos");
        for (String url : Url) {
            driver.get("https://release.drberg.com/health-concern/endocrine-support/" + url);
            sleepInSeconds(3);
//            if (driver.findElement(By.xpath("//a[text() = 'Home']")).isDisplayed())
//            {
//                System.out.println("SP success:" + Url);
...
//            }
    ...
    public void TC_11_Parent_Category_nutrient_enhancement() {
        ...
        Url.add("d3-k2-vitamin-regular");
        for (String url : Url) {
            driver.get("https://release.drberg.com/health-concern/nutrient-enhancement/" + url);
            sleepInSeconds(5);
//            if (driver.findElement(By.xpath("//a[text() = 'Home']")).isDisplayed())
//            {
//                System.out.println("SP success:" + Url);
...
//            }
    ...
    public void TC_11_Parent_Category_hair_nails_skin() {
        ...
        Url.add("raw-wheat-grass-juice-powder-lemon-regular");
        for (String url : Url) {
            driver.get("https://release.drberg.com/health-concern/hair-nails-skin/" + url);
            sleepInSeconds(5);
//            if (driver.findElement(By.xpath("//a[text() = 'Home']")).isDisplayed())
//            {
//                System.out.println("SP success:" + Url);
...
//            }
    ...
    public void TC_11_Parent_Category_pain_inflammation() {
        ...
        Url.add("adrenal-stress-advanced-formula");
        for (String url : Url) {
            driver.get("https://release.drberg.com/health-concern/pain-inflammation/" + url);
            sleepInSeconds(5);
//            if (driver.findElement(By.xpath("//a[text() = 'Home']")).isDisplayed())
//            {
//                System.out.println("SP success:" + Url);
...
//            }
    ...
    public void TC_11_Parent_Category_blood_sugar_support() {
        ...
        Url.add("electrolyte-orange");
        for (String url : Url) {
            driver.get("https://release.drberg.com/health-concern/blood-sugar-support/" + url);
            sleepInSeconds(5);
//            if (driver.findElement(By.xpath("//a[text() = 'Home']")).isDisplayed())
//            {
//                System.out.println("SP success:" + Url);
